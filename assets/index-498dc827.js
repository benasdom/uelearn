 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(T,L){var $=T.length;T.push(L);e:for(;0<$;){var W=$-1>>>1,q=T[W];if(0<a(q,L))T[W]=L,T[$]=q,$=W;else break e}}function n(T){return T.length===0?null:T[0]}function r(T){if(T.length===0)return null;var L=T[0],$=T.pop();if($!==L){T[0]=$;e:for(var W=0,q=T.length,Oe=q>>>1;W<Oe;){var oe=2*(W+1)-1,Se=T[oe],D=oe+1,le=T[D];if(0>a(Se,$))D<q&&0>a(le,Se)?(T[W]=le,T[D]=$,W=D):(T[W]=Se,T[oe]=$,W=oe);else if(D<q&&0>a(le,$))T[W]=le,T[D]=$,W=D;else break e}}return L}function a(T,L){var $=T.sortIndex-L.sortIndex;return $!==0?$:T.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var o=Date,l=o.now();e.unstable_now=function(){return o.now()-l}}var c=[],u=[],d=1,m=null,h=3,w=!1,y=!1,b=!1,C=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(T){for(var L=n(u);L!==null;){if(L.callback===null)r(u);else if(L.startTime<=T)r(u),L.sortIndex=L.expirationTime,t(c,L);else break;L=n(u)}}function k(T){if(b=!1,x(T),!y)if(n(c)!==null)y=!0,De(j);else{var L=n(u);L!==null&&He(k,L.startTime-T)}}function j(T,L){y=!1,b&&(b=!1,g(_),_=-1),w=!0;var $=h;try{for(x(L),m=n(c);m!==null&&(!(m.expirationTime>L)||T&&!A());){var W=m.callback;if(typeof W=="function"){m.callback=null,h=m.priorityLevel;var q=W(m.expirationTime<=L);L=e.unstable_now(),typeof q=="function"?m.callback=q:m===n(c)&&r(c),x(L)}else r(c);m=n(c)}if(m!==null)var Oe=!0;else{var oe=n(u);oe!==null&&He(k,oe.startTime-L),Oe=!1}return Oe}finally{m=null,h=$,w=!1}}var S=!1,N=null,_=-1,R=5,z=-1;function A(){return!(e.unstable_now()-z<R)}function Q(){if(N!==null){var T=e.unstable_now();z=T;var L=!0;try{L=N(!0,T)}finally{L?ge():(S=!1,N=null)}}else S=!1}var ge;if(typeof f=="function")ge=function(){f(Q)};else if(typeof MessageChannel<"u"){var Ae=new MessageChannel,ct=Ae.port2;Ae.port1.onmessage=Q,ge=function(){ct.postMessage(null)}}else ge=function(){C(Q,0)};function De(T){N=T,S||(S=!0,ge())}function He(T,L){_=C(function(){T(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(T){T.callback=null},e.unstable_continueExecution=function(){y||w||(y=!0,De(j))},e.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<T?Math.floor(1e3/T):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(T){switch(h){case 1:case 2:case 3:var L=3;break;default:L=h}var $=h;h=L;try{return T()}finally{h=$}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(T,L){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var $=h;h=T;try{return L()}finally{h=$}},e.unstable_scheduleCallback=function(T,L,$){var W=e.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?W+$:W):$=W,T){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=$+q,T={id:d++,callback:L,priorityLevel:T,startTime:$,expirationTime:q,sortIndex:-1},$>W?(T.sortIndex=$,t(u,T),n(c)===null&&T===n(u)&&(b?(g(_),_=-1):b=!0,He(k,$-W))):(T.sortIndex=q,t(c,T),y||w||(y=!0,De(j))),T},e.unstable_shouldYield=A,e.unstable_wrapCallback=function(T){var L=h;return function(){var $=h;h=L;try{return T.apply(this,arguments)}finally{h=$}}}})(su);iu.exports=su;var e3=iu.exports;/**
 * @license React
...
`;return a?'<pre><code class="language-'+Tt(a)+'">'+(r?i:Tt(i,!0))+`</code></pre>
...
`,zg=["Web Development","Mobile Apps","Frontend","Backend","Ecommerce","Sales Systems","Advertising","UI/UX Design"];function Pg(){return s.jsxs(s.Fragment,{children:[s.jsx("style",{children:Tg}),s.jsxs("div",{className:"amb-root",children:[s.jsx("div",{className:"amb-orb amb-orb-1"}),s.jsx("div",{className:"amb-orb amb-orb-2"}),s.jsx("div",{className:"amb-orb amb-orb-3"}),s.jsx(ht,{to:"/",className:"amb-back",children:s.jsx("i",{className:"fa fa-arrow-left"})}),s.jsxs("div",{className:"amb-card",children:[s.jsxs("div",{className:"amb-badge",children:[s.jsx("div",{className:"amb-badge-dot"}),"Who we are"]}),s.jsxs("h1",{className:"amb-headline",children:["We build ",s.jsx("span",{children:"digital experiences"})," that matter."]}),s.jsx("p",{className:"amb-desc",children:"Unity Elites is a team of developers crafting elegant, high-performance digital products — from sleek frontends to robust backend systems and everything in between."}),s.jsx("div",{className:"amb-pills",children:zg.map(e=>s.jsx("div",{className:"amb-pill",children:e},e))}),s.jsx("div",{className:"amb-divider"}),s.jsxs("a",{className:"amb-cta",href:"https://benasdom.github.io/ue",target:"_blank",rel:"noopener noreferrer",children:["Visit Unity Elites ",s.jsx("span",{className:"amb-cta-arrow",children:"→"})]})]}),s.jsx(Rc,{active:"about"})]})]})}const Og=`
  @import url('https://fonts.googleapis.com/css2?family=Syne:wght@400;700;800&family=Outfit:wght@300;400;500&display=swap');
...
`;function Rg(){const[e,t]=p.useState(!1),[n,r]=p.useState(!1),[a,i]=p.useState({name:"",email:"",phone:"",message:""}),o=u=>{r(u),setTimeout(()=>r(!1),3e3)},l=async()=>{if(Object.values(a).some(u=>!u.trim())){o("Please fill in all fields.");return}t(!0);try{const u=`📩 *New Contact Form Submission*
━━━━━━━━━━━━━━━━━━━━
👤 *Name:* ${a.name}
✉️ *Email:* ${a.email}
📞 *Phone:* ${a.phone}
...
`,eo={height:"50px",width:"auto",borderRadius:"3px",padding:"10px",locale:"en",type:"pay"},L0=function(e){return e&&In(e)==="object"?Object.keys(eo).reduce(function(t,n){return me(me({},t),{},a4({},n,e[n]||eo[n]))},{}):eo},Hg=`
  .pre-checkout-modal {
    display: none;
    position: fixed;
    z-index: 1;
...
`));j.type="text/css",j.styleSheet?j.styleSheet.cssText=S:j.appendChild(document.createTextNode(S)),d.appendChild(j);var N=document.createElement("button");N.classList.add("apple-pay-button",k==="light"?"apple-pay-button-white":"apple-pay-button-black"),N.id="apple-pay-button";var _=document.createElement("span");_.classList.add("logo"),N.appendChild(_),d.appendChild(N)})(e,{styles:L0(o.applePay),theme:o.theme}),l.applePay=!0,c(l)})}else u("No wallet payment method is available on this device");else u("Container to mount elements was not provided")})}function Bg(e){for(;e.firstChild;)e.removeChild(e.firstChild)}var d4="payment-request-button",p4="paystackpop-button",f4="pay-with-vault-button";function h4(e){var t=document.createElement("button");return t.id=p4,t.className="open-paystack-pop-button",t.innerText=e,t}function D0(e){return e.querySelector("#".concat(p4))}function m4(){var e=document.createElement("div");return e.id=d4,e}function no(e){return e.querySelector("#".concat(d4))}function Ug(){var e=document.createElement("button");return e.className="pay-with-vault-button",e.id=f4,e.innerText="Pay with Vault",e}function Wg(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=document.createElement("div");n.className="vault-logo-container",n.innerHTML=Dg,e.appendChild(n);var r=document.createElement("p");r.id="instruction",r.className="vault-instruction",r.innerHTML="Access your saved cards and bank details for faster, more secure payments",e.appendChild(r);var a=Ug();e.appendChild(a);var i=document.createElement("div");if(i.className="vault-divider",i.innerHTML='<div id="vault-divider" class="vault-divider__container"><div class="vault-divider__line"></div></div><div class="vault-divider__text-container"><span class="vault-divider__text">or</span></div>',e.appendChild(i),t.canPayWithApplePay){var o=m4();e.appendChild(o)}if(t.hasOtherPaymentMethods){var l=h4("Use other payment methods");e.appendChild(l)}}function qg(e,t){var n=t.hasOtherPaymentMethods,r=document.createElement("div");r.innerHTML=`
...
`,u.src=c,u.id=l,u.name=l,u}(B.id,i);(function(l,c){var u=document.getElementById(l);u.innerHTML="",u.removeAttribute("style"),u.className="paystack-embed-container",u.style.position="relative",u.style.width="100%",u.appendChild(c)})(t.container,o),o.onload=function(){var l;o.contentWindow.postMessage("PaystackOpen ".concat(B.id),"*"),l=o,new Promise(function(c,u){l||u("No dom element provided"),l.style.display="",l.style.visibility="visible",c()})}}else r.openIframe=function(){V0("openIframe","open","Please consult our documentation at https://developers.paystack.co/docs/paystack-inline"),B.open(a)};return r}}]),e}();if(U0=R0().length>0,W0=qn()&&qn().parentElement.tagName==="FORM",U0&&W0){var so,kn=function(){var e={},t=qn();return R0().forEach(function(n){var r=t.getAttribute(n),a=n.split("data-")[1].replace(/-([a-z])/g,function(i){return i[1].toUpperCase()});e[a]=r}),function(n){if(n.buttonId&&!document.getElementById(n.buttonId))throw new Error("Please make sure the buttonId is an element available in the DOM");var r=me({},n);r.buttonText=n.buttonText||"Pay",r.buttonVariant="normal",r.buttonWordmarkVariant="normal";var a=["normal","light"];return n.buttonVariant&&a.indexOf(n.buttonVariant)>-1&&(r.buttonVariant=n.buttonVariant),n.buttonWordmarkVariant&&a.indexOf(n.buttonWordmarkVariant)>-1&&(r.buttonWordmarkVariant=n.buttonWordmarkVariant),r}(e)}(),q0=qn().parentElement;B||(B=new x4),function(e){var t;if(e.id)(t=document.getElementById(e.id)).setAttribute("data-inline-id",e.id);else{var n=document.createElement("div");n.id="inline-button-".concat(e.inlineId),n.innerHTML=function(r){var a,i,o={normal:`
  ...
  `)}(e),e.parent.parentNode.insertBefore(n,e.parent.nextSibling),t=$g(n.getElementsByTagName("button"),1)[0]}return t}({inlineId:B.id,amount:kn.amount/100,currency:kn.currency,id:kn.buttonId,text:kn.buttonText,variant:kn.buttonVariant,wordmarkVariant:kn.buttonWordmarkVariant,parent:qn()}).addEventListener("click",function(e){e.preventDefault(),so?B.resumeTransaction(so.accessCode):so=B.newTransaction(me(me({},kn),{},{onSuccess:function(t){var n,r,a,i,o,l;n={type:"hidden",name:"reference",value:t.reference,parent:q0},r=n.type,a=n.value,i=n.name,o=n.parent,(l=document.createElement("input")).type=r,l.value=a,l.name=i,o.appendChild(l),q0.submit()}}))})}const sv="/imgs/bob.jpg",ov=({setcredits:e})=>{const t=JSON.parse(localStorage.getItem("userInfo")),[n,r]=p.useState((t==null?void 0:t.credits)||0);let a=de+"/api/v1/user/credits";const[i,o]=p.useState("");p.useState("");const[l,c]=p.useState(!1),[u,d]=p.useState(!1),[m,h]=p.useState(""),w=new Date("Jan 2, 2026 00:00:00").getTime();p.useEffect(()=>{const f=setInterval(function(){const x=new Date().getTime(),k=w-x,j=Math.floor(k/(1e3*60*60*24)),S=Math.floor(k%(1e3*60*60*24)/(1e3*60*60)),N=Math.floor(k%(1e3*60*60)/(1e3*60)),_=Math.floor(k%(1e3*60)/1e3);o(`${j}d ${S}h ${N}m ${_}s left`),k<0&&(clearInterval(f),document.querySelector(".endsin").innerHTML="Promo has ended")},1e3);return()=>clearInterval(f)},[]);const y=async f=>{var k;c(!0);const x=JSON.parse(localStorage.getItem("userInfo"));try{const S=await(await fetch(ma+"/api/v1/initialize-payment",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:(x==null?void 0:x.email)||"customer@email.com",amount:f.amountInGhs,tierName:f.name})})).json(),N=S.access_code||((k=S.data)==null?void 0:k.access_code);N&&new x4().resumeTransaction(N,{onSuccess:R=>{C(f,x,R.reference)},onCancel:()=>c(!1),onError:()=>{c(!1),h("🔴 Payment window error."),d(!0)}})}catch{c(!1),h("🔴 Failed to initialize transaction."),d(!0)}},b=f=>{r(f),e&&e(f)},C=(f,x,k)=>{console.log(k);let j={method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({reference:k,tierName:f.name})};st(a,j).then(S=>{const N=S.added||f.creditReward,_={...x,credits:((x==null?void 0:x.credits)||0)+N,tier:f.premiumType};localStorage.setItem("userInfo",JSON.stringify(_)),b(_.credits),h(`🟢 Success! ${N} credits added.`),d(!0)}).catch(S=>{console.error("Verification error:",S),h("🔴 Payment verification failed or server error."),d(!0)}).finally(()=>c(!1))},g=()=>{window.open("","_self",""),window.close()};return s.jsxs("div",{className:"pcontainer",children:[u&&s.jsx(cv,{setfetchError:d,errorMessage:m}),s.jsxs("div",{className:"pcontainer2",children:[s.jsx("h2",{className:"paytitle",children:"Choose Your Plan"}),s.jsx("h2",{className:"endsin",children:s.jsxs("p",{className:"cdown",children:["PROMO: 🎟️ ",i]})}),s.jsxs("p",{className:"user-credits",children:["💳 Your Credits: ",s.jsx("strong",{children:n})]}),s.jsx("div",{className:"payopts",children:lv.map((f,x)=>s.jsxs("div",{className:"pt",children:[s.jsx("img",{src:f.image,className:"paypic"}),s.jsxs("div",{children:[f.oldPrice&&s.jsx("p",{className:"oprice",children:f.oldPrice}),s.jsxs("p",{className:"nprice",children:[f.oldPrice?"🎟️ ":""," ",f.priceDisplay]})]}),s.jsxs("h3",{className:"tier",children:[s.jsx("span",{className:"goldtop"}),s.jsx("span",{style:{marginRight:"8px"},children:f.icon}),f.name]}),s.jsxs("ul",{className:"payfeatures",children:[s.jsx("p",{style:{fontSize:"25px",margin:"10px 0"},children:f.icon}),f.description.map((k,j)=>s.jsxs("li",{children:[s.jsx("span",{style:{color:"rgb(0,120,250)"},children:"✔"})," ",k]},j))]}),s.jsx("button",{className:"watch",onClick:()=>f.button!=="default"&&y(f),style:{pointerEvents:f.button==="default"?"none":"all"},children:f.button!=="default"?s.jsx("div",{className:"sp",children:f.button}):s.jsx("div",{children:"Active"})})]},f.name+x))}),s.jsxs("div",{className:"return",onClick:g,children:[s.jsx(ga,{})," "]})]}),l?s.jsx(Wi,{opacity:1,indexed:100,mainlogo:Ot}):s.jsx(Wi,{opacity:0,indexed:-100})]})},lv=[{name:"Normal User",premiumType:"normal-user",priceDisplay:"Free",amountInGhs:0,creditReward:0,icon:s.jsx(Xm,{style:{color:"#FFD700"}}),image:sv,description:["Access to referral tools","Basic analytics"],button:"default"},{name:"Credit Pack",premiumType:"credits",priceDisplay:"GHS 25",amountInGhs:25,creditReward:200,icon:s.jsx(R7,{style:{color:"#FFD700"}}),image:b2,description:["200 AI Credits","Standard Support","No Expiry"],button:"Buy Now"},{name:"Premium User",premiumType:"premium-user",oldPrice:"GHS 20/month",priceDisplay:"GHS 50 lifetime",amountInGhs:50,creditReward:600,icon:s.jsx(i5,{style:{color:"#FFD700"}}),image:y2,description:["Access to referral tools","500 + 100 Bonus Credits","Priority support"],button:"Upgrade"},{name:"Affiliate",premiumType:"affiliate",oldPrice:"GHS 70/month",priceDisplay:"GHS 500 lifetime",amountInGhs:500,creditReward:1500,icon:s.jsx(Cm,{style:{color:"#FFD700"}}),image:w2,description:["All Premium features","1500 Bonus Credits","Monthly Earns: 1.5k-2k cedis"],button:"Go Pro"}],cv=({errorMessage:e,setfetchError:t})=>(p.useEffect(()=>{const n=setTimeout(()=>t(!1),3e3);return()=>clearTimeout(n)},[]),s.jsx("div",{className:"toast",children:s.jsx("div",{className:"successmessage",children:e.toLowerCase()})}));const uv=()=>{const[e,t]=p.useState(0);return s.jsx(Xp,{basename:"/",children:s.jsxs(qp,{children:[s.jsx(Wn,{path:"/",element:s.jsx(_g,{})}),s.jsx(Wn,{path:"/contact",element:s.jsx(Rg,{})}),s.jsx(Wn,{path:"/about",element:s.jsx(Pg,{})}),s.jsx(Wn,{path:"/payment",element:s.jsx(ov,{setcredits:t})}),s.jsx(Wn,{path:"*",element:s.jsx(Lg,{})})]})})};lo.createRoot(document.getElementById("root")).render(s.jsx(di.StrictMode,{children:s.jsx(uv,{})}));
